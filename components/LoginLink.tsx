 ...
 *
 * In an in-app browser (a tap from an Instagram bio or a WhatsApp message) the
 * new tab is blocked silently and the tap does nothing at all, so when the open
 * comes back empty we fall back to navigating this tab.
 */
